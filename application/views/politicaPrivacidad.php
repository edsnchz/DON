        ...
        <div class="row">
            <div class="col-sm-12">
                ...
                <p class="fontFamilyRoboto fontSize14px fontWeight400">Para acceder a algunos de los servicios que
                    ...
                    <br><br>
                    El usuario podrá en cualquier momento ejercitar los derechos de acceso, oposición, rectificación y
                    cancelación de sus datos personales. El ejercicio de estos derechos puede
                ...
                <p class="fontFamilyRoboto fontSize14px fontWeight400">Trataremos tus datos personales recabados a
                    ...
                    usuario.
                    <br><br>
                    <b>Formulario "Crear Anuncio":</b> Para poderte prestar el servicio solicitado, para que puedas
                    publicar anuncios y otros usuarios puedan contactar contigo. Recuerda que los datos que facilites en
                    este formulario serán públicos.
                    <br><br>
                    <b>Formulario "Mensaje Privado":</b> Para que puedas contactar con anunciantes, estos datos son
                    privados y serán enviados al anunciante. Nunca cederemos estos datos. En el caso que seas un
                    anunciante la persona que te contacte nunca sabrá tu email a menos que
                    le respondas al correo que te envía la web.
                    <br><br>
                    <b>Formulario "Reportar Anuncio":</b>Para poder reportar el mal uso de los anuncios. Estos datos son
                    privados y una vez ejercida una acción podemos responderte por email las acciones tomadas. Nunca
                    cederemos estos datos y nunca te enviaremos ningún boletín a ellos.
                    <br><br>
                    Remitir boletines (newsletters), así como comunicaciones comerciales de promociones y/o publicidad
                    del SITIO WEB, nunca de terceros.
                    <br><br>
                    Contabilidad, sólo para los usuarios que pongan un anuncio de pago almacenaremos sus datos para
                    poder realizar facturas o tiquetes de caja si la solicitas.
                    <br><br>
                    Te recordamos que puedes oponerte al envío de comunicaciones comerciales por cualquier vía y en
                    cualquier momento, enviando un mensaje por nuestro formulario de contacto.
                    <br><br>
                ...
                <p class="fontFamilyRoboto fontSize14px fontWeight400">Los datos personales proporcionados se
                    ...
                    <br><br>
                    Una vez elimines un anuncio la ley nos obliga a guardar los datos de los anuncios borrados por
                ...
                <p class="fontFamilyRoboto fontSize14px fontWeight400">El tratamiento de tus datos se realiza con las
                    ...
                    tu disposición la presente política de privacidad, que tras la lectura de la misma, en caso de estar
                    conforme, puedes aceptar mediante una declaración o una clara acción afirmativa, como el marcado de
                    una casilla dispuesta al efecto. En caso de que no nos facilites tus datos o lo hagas de forma
                ...
                <p class="fontFamilyRoboto fontSize14px fontWeight400">Los datos no se comunicarán a ningún tercero
                    ...
                    cumplimiento de las disposiciones normativas, de aplicación en materia de protección de datos, en el
                ...
                <p class="fontFamilyRoboto fontSize14px fontWeight400">‘doneroticos.com’ informa de que, como
                    ...
                    servicio. La retención de estos datos no afecta al secreto de las comunicaciones y sólo podrán ser
                    utilizados en el marco de una investigación criminal o para la salvaguardia de la seguridad pública,
                    poniéndose a disposición de los jueces y/o tribunales o del Ministerio que así los requiera.
                    <br><br>
                ...
                <p class="fontFamilyRoboto fontSize14px fontWeight400">El usuario debe respetar los programas de
                    ...
                    necesario para la prestación del servicio, ni tampoco sobre la información técnica de seguimiento
                    del servicio, excepción hecha de los derechos y licencias necesarios para el cumplimiento de los
                ...
                <p class="fontFamilyRoboto fontSize14px fontWeight400">Se prohíbe el uso contrario a la legislación
                    ...
                    <br><br>
                    La utilización del servidor de correo del dominio y de las direcciones de correo electrónico para el
                    envío de correo masivo no deseado.
                    <br><br>
                    El usuario tiene toda la responsabilidad sobre el contenido de su anuncio, la información
                    transmitida y
                    almacenada, los enlaces de hipertexto, las reivindicaciones de terceros y las acciones legales en
                    referencia a propiedad intelectual, derechos de terceros y protección de menores.
                    <br><br>
                    El usuario es responsable respecto a las leyes y reglamentos en vigor y las reglas que tienen que
