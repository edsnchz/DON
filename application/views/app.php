        ...
        <div class="row">
            <div class="col-xl-12 mx-auto padding0 IndexHeader">
                ...
                <div class="overlayTextHeader fontFamilyRoboto width70porcientoMovil">
                    ...
                    <p class="colorGrisClaro d-none d-md-block">En <strong>doneroticos.com</strong> encontrarás
            ...
            <div class="row paddingLaterales120px margin_top_30px paddingLaterales35pxMovil">
                <div class="col-lg-3">
                    ...
                    width85porciento width100porcientoMovil minHeight300px">
                        ...
                        <p class="fontFamilyRoboto margin_top_30px paddingLaterales20px fontSize14px fontWeight400">
                            Te regalamos 100 créditos por publicar tu primer anuncio. Y en cada compra recibe créditos
                            adicionales.</p>
                    </div>
                </div>
                ...
                <div class="col-lg-3">
                    ...
                    width85porciento width100porcientoMovil minHeight300px">
                        ...
                        <h3 class="colorGrisOscuro fontSize16px fontWeight600 textUppercase margin_top_30px">
                            Galería de fotos</h3>
                        <p class="fontFamilyRoboto margin_top_30px paddingLaterales20px fontSize14px fontWeight400">Cada vez
                            que subes una foto esta se guarda en tu galería privada para que la puedas reutilizar en otros
                            anuncios.</p>
                    </div>
                </div>
                ...
                <div class="col-lg-3">
                    ...
                    width85porciento width100porcientoMovil minHeight300px">
                        ...
                        <p class="fontFamilyRoboto margin_top_30px paddingLaterales20px fontSize14px fontWeight400">Agrega
            ...
            <div class="row margin_top_30px paddingLaterales120px paddingLaterales35pxMovil">
                ...
                <div class="col-lg-3">
                    ...
                    width85porciento width100porcientoMovil minHeight300px">
                        ...
                        <p class="fontFamilyRoboto margin_top_30px paddingLaterales20px fontSize14px fontWeight400">Datos
                            reales del rendimiento de tus anuncios, actualizados instantáneamente. Controla la inversión de
                            tus
                            créditos.</p>
                    </div>
                </div>
                ...
                <div class="col-lg-3">
                    ...
                    width85porciento width100porcientoMovil minHeight300px">
                        ...
                        <h3 class="colorGrisOscuro fontSize16px fontWeight600 textUppercase margin_top_30px">
                            Medios de pago</h3>
                        <p class="fontFamilyRoboto margin_top_30px paddingLaterales20px fontSize14px fontWeight400">Compra
                            créditos de forma fácil y segura, sin pagar comisiones extras y recibelos inmediatamente.</p>
                    </div>
                </div>
            ...
            <div class="row">
                <div class="col-lg-12 my-auto showcase-text">
                    ...
                    <p class="fontSize14px fontFamilyRoboto fontWeight400"><strong>doneroticos.com</strong> es
                        ...
                        <strong>doneroticos.com</strong></p>
                </div>
            </div>
        </div>
    </section>
