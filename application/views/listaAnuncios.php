...
<!-- CAROUSEL -->
<div id="divCarouselPadre" class="owl-carousel owl-theme margin_top_medium">
...
<div class="alert alert-success divCTACarousel colorWhite pulse borderRadius0px" role="alert">
  ...
  <hr style="margin: 7px">
  <p class="mb-0 fontFamilyRoboto">Click para más información</p>
</div>
...
<div class="container container-mas-grande">
    <div class="row">
        ...
        <div class="col-sm-9" id="divCuadricula">
            <div class="card-columns" id="divCardColumns">
                <!-- ANUNCIOS -->
            </div>
        </div>
    </div>
