...
<div class="pageComplete">
    ...
    <div class="container-fluid">
        ...
        <div id="btnsStyleGrid" class="pull-right d-none d-sm-block">
            <label class="fontSize13px fontFamilyRoboto colorGrisMenosClaro"><span
                    class="countTotalAnuncios fontWeight600 fontSize14px">-</span>
                Anuncios</label>
            <div class="btn-group padding0 paddingRight105px" role="group">
                ...
                <button type="button" class="btn btnViewList inactivo"><span
                        class="oi oi-list-rich fontSize18px margin0"></span></button>
            </div>
        </div>
    </div>
            ...
            <div class="col-sm-3">
                ...
                <div id="btnsStyleGridMovil" class="pull-right d-block d-sm-none margin_top_masSmall">
                    ...
                    <div class="btn-group padding0" role="group">
                        <button type="button" class="btn btnViewTable"><span
                                class="oi oi-grid-three-up"></span></button>
                        <button type="button" class="btn btnViewList inactivo"><span
                                class="oi oi-list-rich fontSize18px margin0"></span></button>
                    </div>
                </div>
